...
public:
     ...
     */
    bool begin(ESP_SSLClient &client, String url);
    bool begin(ESP_SSLClient &client, String host, uint16_t port, String uri = "/", bool https = false);
    ...
    ESP_SSLClient &getStream(void);
    ESP_SSLClient *getStreamPtr(void);
...
protected:
    ...
    std::unique_ptr<ESP_SSLClient> _tcpDeprecated;
#endif

    ESP_SSLClient *_client = nullptr;
